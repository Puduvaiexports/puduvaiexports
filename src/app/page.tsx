...
export default function Home() {
  ...
  const brochureItems = [
    { category: "Healthcare", name: "5 Nature", icon: "🌱", href: "#" },
    { category: "FMCG", name: "Tasty6", icon: "🥘", href: "#" },
    { category: "Healthcare", name: "First Care", icon: "🛡️", href: "/brochures/first-care" },
  ];
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl text-center md:text-left">
              ...
              <Link
                href="/brochures/first-care"
                className="bg-white text-blue-600 px-10 py-4 rounded-xl font-bold hover:bg-blue-50 transition-all shadow-xl flex items-center gap-3 mx-auto md:mx-0"
              >
